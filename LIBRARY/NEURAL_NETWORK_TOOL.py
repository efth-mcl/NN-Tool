...
class NNtool:
    ...
    def buildnet(self, TopologyDir, NewWeights=True):
            ...
            if not self.NewWeights:
                ...
                self.Weights_Bin_File = open('../TOPOLOGYS/'+TopologyDir+'/Weights.Bin', 'br')
                self.Bias_Bin_File = open('../TOPOLOGYS/'+TopologyDir+'/Bias.Bin', 'br')
    ...
    def SaveWeights(self):
        Weights_Bin = open("../TOPOLOGYS/"+self.TopologyDir+"/Weights.Bin", 'bw')
        Bias_Bin = open("../TOPOLOGYS/"+self.TopologyDir+"/Bias.Bin", 'bw')
